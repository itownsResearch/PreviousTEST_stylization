...
//console.log("Feature2MeshFeature2MeshFeature2Mesh",Feature2Mesh);
////////////////////////////////////////////////////////////////////////////////////// VERTEX SHADERS ////////////////////////////////////////////////////////////////////////////////////
...
function addShader(result){
  //console.log("batiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiii", result);
  //result.material = ShadMatWalls;
...
function altitudeBuildings(properties) {
    return -40 - properties.hauteur;
}

let getColorForLevelX = (nivEau) => ( (alti) => new THREE.Color(0XFFFF00)/*getColor(alti, nivEau)*/ );
...
let bati = {
    ...
    convert:  Feature2Mesh.default.convert({
    ...
    source: {
        ...
        zoom: { min: 15, max: 18 },  // Beware that showing building at smaller zoom than ~16 create some holes as the WFS service can't answer more than n polylines per request
    }
};
