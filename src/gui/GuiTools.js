...
GuiTools.prototype.addGeometryLayerGUI = function addGeometryLayerGUI(layer, ShadMatRoof, ShadMatWalls, ShadMatEdges) {
...
GuiTools.prototype.addGeometryLayersGUI = function addGeometryLayersGUI(layers, ShadMatRoof, ShadMatWalls, ShadMatEdges) {
    var i;
    for (i = 0; i < layers.length; i++) {
        this.addGeometryLayerGUI(layers[i], ShadMatRoof, ShadMatWalls, ShadMatEdges);
    }
};
